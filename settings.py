...
SECRET_KEY = 'django-insecure-&ou+gg^bksa+oc4$p--ik8w@fuip!8hbw=p$opdwoaddjk_uuv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'blood_bank/templates')],
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blood_bank_db',  # Replace with your database name
